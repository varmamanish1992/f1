...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About FNZcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>FNZcoin</b> version", 0));
...
"Copyright \302\251 2017 The FNZcoin developers", 0));
